...
"""
# Quick Mode Example:
User: "Write a blog about why most people fail at their goals"

Agent will:
1. Take the topic
2. Apply the framework
3. Create a complete blog with personal touches
4. Follow PPP structure
5. Deliver 1500-2500 words


# Full Mode Example:
User provides complete Notion template:

Quick Capture: Goals fail because of environment design
Research: 
- James Clear's Atomic Habits concepts
- BJ Fogg's Behavior Model
- Personal experience with 7 failed businesses

Planning:
- Audience: Entrepreneurs 25-40
- Topic: Goal achievement through environment design
- Big Problem: People rely on willpower instead of systems
- Personal Experience: Failed 7 businesses before understanding this
- Framework: The 3E System (Environment, Energy, Execution)

Agent will:
1. Incorporate ALL this depth
2. Weave in the research naturally
3. Share the personal failures authentically
4. Create the 3E Framework concept
5. Make it uniquely the user's voice
6. Deliver a masterpiece


# To Run:
1. Save this file as blog_writer_agent/agent.py
2. Create blog_writer_agent/__init__.py (empty file)
3. Run: adk web
4. Select "blog_writer" from dropdown
...
Quick Mode:
- "Write a blog about productivity for remote workers"
- "Create a newsletter about why most marketing fails"
- "Blog post: the one skill that changed my business"

Full Mode:
- "Here's my Notion template filled out: [paste full template]"
- "Create a blog with this info: Topic: [X], Audience: [Y], Research: [Z]..."
- "I want to write about [topic]. My target audience is [audience]. 
   The big problem is [problem]. My personal experience: [experience].
   My goal is to [goal]."
...
User: "Add more personal stories"
User: "Focus more on the framework section"
User: "Make the introduction more controversial"
User: "Cut it down to 1200 words"

The agent remembers the context and will adjust accordingly!
"""