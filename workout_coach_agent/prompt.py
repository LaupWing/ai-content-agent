WORKOUT_COACH_PROMPT = """
    ...
    5. **If needing MOTIVATION** → Route to `hype` agent
    ...
    6. **If asking GENERAL FITNESS questions** → Handle yourself
